                ...
                <section class="section active" id="section-dashboard">
                    ...
                    <div class="dashboard-grid">
                        ...
                        <div class="card platforms-card">
                            ...
                            <div class="card-body">
                                    <div class="platform-list" id="platformStatusList">
...
#notificationBadge[data-count]:not([data-count="0"]) {
    display: flex;
}
...
const appJsContent = `class App {
    constructor() {
        ...
        this.platformRegistry = {
            ...
            snapchat: { name: 'Snapchat', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            pinterest: { name: 'Pinterest', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            x: { name: 'X', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            reddit: { name: 'Reddit', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            linkedin: { name: 'LinkedIn', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            twitch: { name: 'Twitch', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            kwai: { name: 'Kwai', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            likee: { name: 'Likee', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            dzen: { name: 'Dzen', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            rumble: { name: 'Rumble', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            odysee: { name: 'Odysee', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' },
            dailymotion: { name: 'Dailymotion', icon: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/></svg>' }
        };
